  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mb-2">V2</p>
        ...
        <div className="flex flex-col gap-3 w-full">
          <button
            ...
            className="glow-button w-full py-3.5 rounded-xl font-semibold text-sm text-primary-foreground flex items-center justify-center gap-2"
          >
            Créer un compte
          ...
          <button
            ...
            className="glass-card w-full py-3.5 rounded-xl font-semibold text-sm text-foreground hover:bg-secondary/50 transition-colors"
          >
            Se connecter
          </button>
        </div>
